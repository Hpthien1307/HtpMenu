...
export class OpinionsController {
  ...
  async getOpinions(): Promise<ResponseData<Opinion[]>> {
    try {
      ...
      return new ResponseData<Opinion[]>(
        data,
        HttpStatus.OK,
        HttpMessage.SUCCESS
      );
  ...
  @Post()
  async createOpinion(@Body() opinion: Opinion): Promise<ResponseData<Opinion>> {
    try {
      const data = await this.opinionsService.createOpinion(opinion);
      return new ResponseData<Opinion>(
        data,
        HttpStatus.OK,
        HttpMessage.SUCCESS
  ...
  async updateOpinion(
    @Param("id") id: string,
    @Body() opinion: Partial<Opinion>
  ): Promise<ResponseData<Opinion>> {
    try {
